package com.example.rocheoffline.spaceshooter;
...
public class Player {
    ...
    public Player(Context context, int screenSizeX, int screenSizeY, SoundPlayer soundPlayer) {
        ...
        mSpeed = 3;
        mBitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.kapal);
        mBitmap = Bitmap.createScaledBitmap(mBitmap, mBitmap.getWidth() * 5/5, mBitmap.getHeight() * 5/5, false);
